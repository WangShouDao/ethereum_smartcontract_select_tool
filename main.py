...
if __name__=='__main__':
    ...
    for i in range(1, 950):
        spider_content(i)
    spider.spider_contentdrawing.draw_plot1(content_filename)
    spider.spider_content.drawing.draw_plot2(content_filename)
    spider.spider_content.drawing.draw_scatter(content_filename)
